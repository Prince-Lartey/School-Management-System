...
import {BsGraphUp, BsPeople, BsPerson, BsFileText, BsGraphDown, BsCalendar, BsGear, BsCalendarEvent, BsChatDots, BsBook} from 'react-icons/bs'
import {  ToggleIcon } from '../../styles/SidebarStyles'
import schoolhubLogo4 from "../../assets/schoolhubLogo4.png"
import axios from 'axios'
import { FaBookOpen, FaChartBar, FaChartLine, FaChevronDown, FaChevronUp, FaClipboardList, FaLayerGroup, FaSignOutAlt } from 'react-icons/fa'
    ...
    return (
        <div className="fixed top-0 left-0 w-[250px] h-full bg-[#2c3e50] text-white overflow-y-auto pt-[60px] transition-all duration-300 ease-in-out z-[100]" style = {{width: isOpen ? '280px' : '65px'}} >
            ...
            <ul className='list-none p-0'>
                <Link to='/teacher/dashboard' className='flex items-center py-3 px-5 text-base  hover:bg-gray-500 hover:text-white hover:rounded-r-3xl'>
                    <div className='mr-4'><BsGraphUp /></div>
                    <p  className="no-underline text-white ml-4">Dashboard</p>
                </Link>

                <Link to='/teacher/grades' className='flex items-center py-3 px-5 text-base  hover:bg-gray-500 hover:text-white hover:rounded-r-3xl'>
                    <div className='mr-4'><FaLayerGroup /></div>
                    <p  className="no-underline text-white ml-4">Grades</p>
                </Link>

                <Link to='/teacher/subjects' className='flex items-center py-3 px-5 text-base  hover:bg-gray-500 hover:text-white hover:rounded-r-3xl'>
                    <div className='mr-4'><FaBookOpen /></div>
                    <p  className="no-underline text-white ml-4">Subjects</p>
                </Link>

                <Link to='/teacher/students' className='flex items-center py-3 px-5 text-base  hover:bg-gray-500 hover:text-white hover:rounded-r-3xl'>
                    <div className='mr-4'><BsPeople /></div>
                    <p  className="no-underline text-white ml-4">Students</p>
                </Link>

                <Link to='/teacher/teachers' className='flex items-center py-3 px-5 text-base  hover:bg-gray-500 hover:text-white hover:rounded-r-3xl'>
                    <div className='mr-4'><BsPerson /></div>
                    <p  className="no-underline text-white ml-4">Teachers</p>
                </Link>

                <Link to='/teacher/assignment' className='flex items-center py-3 px-5 text-base  hover:bg-gray-500 hover:text-white hover:rounded-r-3xl'>
                ...
                {isExamsOpen && (
                    <ul className='list-none px-5'>
                        <Link to='/teacher/exams/results' className='flex items-center py-2 px-8 text-sm  hover:bg-gray-500 hover:text-white hover:rounded-r-3xl'>
                            <div className='mr-4'><FaChartBar /></div>
                            <p  className="no-underline text-white">Exam Results</p>
                        </Link>
                        <Link to='/teacher/exams/reports' className='flex items-center py-2 px-8 text-sm  hover:bg-gray-500 hover:text-white hover:rounded-r-3xl'>
                ...
                <Link to='/teacher/performance' className='flex items-center py-3 px-5 text-base  hover:bg-gray-500 hover:text-white hover:rounded-r-3xl'>
                ...
                {isAttendanceOpen && (
                    <ul className='list-none px-5'>
                        <Link to='/teacher/attendance/add' className='flex items-center py-2 px-8 text-sm  hover:bg-gray-500 hover:text-white hover:rounded-r-3xl'>
                            <div className='mr-4'><FaClipboardList /></div>
                            <p  className="no-underline text-white">Take Attendance</p>
                        </Link>
                        <Link to='/teacher/attendance/summary' className='flex items-center py-2 px-8 text-sm  hover:bg-gray-500 hover:text-white hover:rounded-r-3xl'>
                ...
                <Link to='/teacher/announcements' className='flex items-center py-3 px-5 text-base  hover:bg-gray-500 hover:text-white hover:rounded-r-3xl'>
                    <div className='mr-4'><BsChatDots /></div>
                    <p className="no-underline text-white ml-4">Announcements</p>
                </Link>

                <Link to='/teacher/eventCalendar' className='flex items-center py-3 px-5 text-base  hover:bg-gray-500 hover:text-white hover:rounded-r-3xl'>
                    <div className='mr-4'><BsCalendarEvent /></div>
                    <p className="no-underline text-white ml-4">Event and Calendar</p>
                </Link>

                <Link to='/teacher/profile' className='flex items-center py-3 px-5 text-base  hover:bg-gray-500 hover:text-white hover:rounded-r-3xl'>
                    <div className='mr-4'><BsGear /></div>
                    <p className="no-underline text-white ml-4">Profile</p>
                </Link>

                <Link to='/' className='flex items-center py-3 px-5 mt-10 mb-5 text-base  hover:bg-gray-500 hover:text-white hover:rounded-r-3xl' onClick={handleLogout}>
